...
export const conditionInfoMap: Record<string, ConditionInfo> = {
	...
	hypertension: {
		...
		symptomGroups: [
			...
			{ labelKey: 'symptom_group.sleep', rationaleKey: 'condition.hypertension.rationale_sleep', items: ['symptom.slept_well', 'symptom.slept_badly'] },
		],
	...
	menopause: {
		...
		symptomGroups: [
			...
			{ labelKey: 'symptom_group.sleep', rationaleKey: 'condition.menopause.rationale_sleep', items: ['symptom.slept_well', 'symptom.slept_badly', 'symptom.wake_frequent', 'symptom.insomnia'] },
